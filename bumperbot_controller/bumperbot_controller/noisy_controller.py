...
class NoisyController(Node):
    ...
    def __init__(self):
        ...
        self.joint_sub_ = self.create_subscription(JointState,"joint_states", self.jointstate_callback, 10)        
    ...
    def jointstate_callback(self, msg):
        ...
        linear_vel = (self.wheel_radius_ * fi_right + self.wheel_radius_ * fi_left) / 2
